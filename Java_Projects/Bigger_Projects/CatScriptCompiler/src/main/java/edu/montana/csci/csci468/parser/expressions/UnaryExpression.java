...
public class UnaryExpression extends Expression {
    ...
    public Object evaluate(CatscriptRuntime runtime) {
        ...
        if (this.isMinus()) {
            ...
            if(isNot()){
                if(rhsValue.toString().equals("false")){
                    return true;
                } else if (rhsValue.toString().equals("true")) {
                    return false;
                }
            }
        }
    ...
    public void compile(ByteCodeGenerator code) {
        ...
        if(this.isNot()){
            ...
            code.addJumpInstruction(Opcodes.IFNE, Label_1);
            code.addInstruction(Opcodes.ICONST_1);
            code.addJumpInstruction(Opcodes.GOTO, Label_2);
            code.addLabel(Label_1);
            code.addInstruction(Opcodes.ICONST_0);
            code.addLabel(Label_2);
        }
        //super.compile(code);
    }
