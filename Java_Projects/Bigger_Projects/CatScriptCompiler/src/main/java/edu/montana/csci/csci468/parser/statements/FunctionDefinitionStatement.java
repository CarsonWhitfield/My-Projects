...
public class FunctionDefinitionStatement extends Statement {
    ...
    private boolean validateReturnCoverage(List<Statement> statements) {
        ...
        for (Statement statement : statements) {
            if (statement instanceof ReturnStatement) {
                ...
                boolean ifBranch = validateReturnCoverage(ifStatement.getTrueStatements());
                boolean elseBranch = ifStatement.getElseStatements() != null && validateReturnCoverage(ifStatement.getElseStatements());
    ...
    public void compile(ByteCodeGenerator code) {
        ...
        for(String arg: argumentNames){
            code.createLocalStorageSlotFor(arg);
        }
        for(Statement statement : body){
